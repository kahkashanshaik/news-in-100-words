...
class Display
{
	...
	public function enqueue_assets(): void
	{
		...
		wp_enqueue_script(
			'news-in-100-words-frontend',
			$plugin_url . 'assets/frontend/js/index.js',
			array(),
		...
		wp_enqueue_style(
			'news-in-100-words-frontend',
			$plugin_url . 'assets/frontend/css/index.css',
			array(),
			HUNDRED_WORDS_NEWS_VERSION
		);
	...
	{
		global $post;
		if ($post && has_shortcode($post->post_content, 'hundred_words_news_thunderbolt')) {
	...
	public function add_icon_to_title(string $title, int $post_id = 0): string
	{
		...
		// Escape summary for HTML attribute using WordPress escaping function.
		$summary_encoded = esc_attr($summary);
		
		$icon = sprintf(
			'<span class="hwn-icon %s" data-post-id="%s" data-summary="%s" data-title="%s" data-permalink="%s" data-date="%s" data-image="%s" data-category="%s" style="color: %s;" aria-label="%s" role="button" tabindex="0">
				⚡
			</span>',
			esc_attr($size_class),
			...
			esc_attr($category),
			esc_attr($icon_color),
			esc_attr__('View summary', 'news-in-100-words')
		);

		// Unmark as processing
		unset(self::$processing[$post_id]);

		// Escape the title before returning to ensure safe output.
		// WordPress may have already escaped it, but we ensure it's safe.
		return esc_html($title) . ' ' . $icon;
	}
		...
		<div id="hwn-popup" class="hwn-popup hwn-popup-<?php echo esc_attr($popup_theme); ?>" role="dialog" aria-labelledby="hwn-popup-title" aria-hidden="true">
			...
			<div class="hwn-popup-wrapper">
				<div class="hwn-popup-card">
					<button class="hwn-popup-close" aria-label="<?php esc_attr_e('Close', 'news-in-100-words'); ?>">&times;</button>
					...
					<div class="hwn-popup-card-content">
						...
						<div class="hwn-popup-meta">
							...
							<span class="hwn-popup-info-icon" aria-label="<?php esc_attr_e('AI Summary Information', 'news-in-100-words'); ?>">
								...
								<div class="hwn-popup-tooltip">
									<?php esc_html_e('Summary is AI-generated, newsroom-reviewed', 'news-in-100-words'); ?>
								</div>
							</span>
						</div>

						<!-- AI Generated Summary -->
						<!-- <div class="hwn-popup-label"><?php esc_html_e('AI Generated News Summary', 'news-in-100-words'); ?></div> -->
						...
						<div class="read-more-button-wrapper">
							<a href="#" class="hwn-popup-readmore" target="_blank" rel="noopener noreferrer"
								...
								<?php esc_html_e('Read more', 'news-in-100-words'); ?>
							</a>
						</div>
					</div>
					...
					<!-- <div class="hwn-popup-share">
						...
						<div class="hwn-popup-share-buttons">
							<a href="#" class="hwn-share-btn hwn-share-facebook" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e('Share on Facebook', 'news-in-100-words'); ?>">
							...
							<a href="#" class="hwn-share-btn hwn-share-twitter" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e('Share on Twitter', 'news-in-100-words'); ?>">
								<svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
							...
							<a href="#" class="hwn-share-btn hwn-share-whatsapp" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e('Share on WhatsApp', 'news-in-100-words'); ?>">
								<svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
							...
							<a href="#" class="hwn-share-btn hwn-share-reddit" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e('Share on Reddit', 'news-in-100-words'); ?>">
								<svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
							...
							<a href="#" class="hwn-share-btn hwn-share-email" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e('Share via Email', 'news-in-100-words'); ?>">
								<svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
							...
							<a href="#" class="hwn-share-btn hwn-share-link" aria-label="<?php esc_attr_e('Copy Link', 'news-in-100-words'); ?>">
								<svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
