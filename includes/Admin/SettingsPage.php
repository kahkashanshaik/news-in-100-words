...
class SettingsPage {
	...
	public function register_settings(): void {
		register_setting('hundred_words_news_settings', 'hundred_words_news_settings', array($this, 'sanitize_settings'));
	}
	...
	public function render_page(): void {
		...
		?>
		<div class="wrap">
			<h1><?php esc_html_e('Hundred Words News Settings', 'hundred-words-news'); ?></h1>

			<form method="post" action="">
				<?php wp_nonce_field('hundred_words_news_settings'); ?>

				<h2 class="nav-tab-wrapper">
					<a href="#api-model" class="nav-tab nav-tab-active"><?php esc_html_e('API & Model', 'hundred-words-news'); ?></a>
					<a href="#summary-generation" class="nav-tab"><?php esc_html_e('Summary Generation', 'hundred-words-news'); ?></a>
					<a href="#icon-settings" class="nav-tab"><?php esc_html_e('Icon Settings', 'hundred-words-news'); ?></a>
					<a href="#popup-settings" class="nav-tab"><?php esc_html_e('Popup Settings', 'hundred-words-news'); ?></a>
					<a href="#thunderbolt-page" class="nav-tab"><?php esc_html_e('Thunderbolt Page', 'hundred-words-news'); ?></a>
				</h2>
				...
				<div id="api-model" class="tab-content">
					<table class="form-table">
						<tr>
							<th scope="row">
								<label for="provider"><?php esc_html_e('AI Provider', 'hundred-words-news'); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e('Select the AI provider to use for summary generation.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="api_key"><?php esc_html_e('API Key', 'hundred-words-news'); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e('Enter your API key for the selected provider.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="model"><?php esc_html_e('Model', 'hundred-words-news'); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e('Select the AI model to use.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="timeout"><?php esc_html_e('Timeout (seconds)', 'hundred-words-news'); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e('API request timeout in seconds.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="api_delay"><?php esc_html_e('API Delay (ms)', 'hundred-words-news'); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e('Delay between API calls in milliseconds to avoid rate limits.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
					</table>
				</div>
				...
				<div id="summary-generation" class="tab-content" style="display:none;">
					<table class="form-table">
						<tr>
							<th scope="row">
								<label for="default_length"><?php esc_html_e('Default Length', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<select name="hundred_words_news_settings[default_length]" id="default_length">
									<option value="short" <?php selected($settings['default_length'], 'short'); ?>><?php esc_html_e('1 paragraph', 'hundred-words-news'); ?></option>
									<option value="medium" <?php selected($settings['default_length'], 'medium'); ?>><?php esc_html_e('2 paragraphs', 'hundred-words-news'); ?></option>
									<option value="large" <?php selected($settings['default_length'], 'large'); ?>><?php esc_html_e('3 paragraphs', 'hundred-words-news'); ?></option>
								</select>
								<p class="description"><?php esc_html_e('Default summary length preset. The summary will be formatted as bullet points.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="default_language"><?php esc_html_e('Default Language', 'hundred-words-news'); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e('Default language for summaries.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<?php esc_html_e('Auto-Generate', 'hundred-words-news'); ?>
							</th>
							<td>
								<label>
									<input type="checkbox" name="hundred_words_news_settings[auto_generate]" value="1" 
										   <?php checked($settings['auto_generate'], 1); ?>>
									<?php esc_html_e('Automatically generate summary when post is saved (if no summary exists)', 'hundred-words-news'); ?>
								</label>
							</td>
						</tr>
					</table>
				...
				<div id="icon-settings" class="tab-content" style="display:none;">
					<table class="form-table">
						<tr>
							<th scope="row">
								<label for="icon_size"><?php esc_html_e('Icon Size', 'hundred-words-news'); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e('Size of the summary icon.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="icon_color"><?php esc_html_e('Icon Color', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<input type="color" name="hundred_words_news_settings[icon_color]" id="icon_color" 
									   value="<?php echo esc_attr($settings['icon_color']); ?>">
								<p class="description"><?php esc_html_e('Color of the summary icon.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
					</table>
				</div>
				...
				<div id="popup-settings" class="tab-content" style="display:none;">
					<table class="form-table">
						<tr>
							<th scope="row">
								<label for="popup_theme"><?php esc_html_e('Popup Theme', 'hundred-words-news'); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e('Theme for the summary popup modal.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="readmore_button_color"><?php esc_html_e('Read More Button Color', 'hundred-words-news'); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e('Background color for the "Read more" button in the popup.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="list_bullet_color"><?php esc_html_e('List Bullet Color', 'hundred-words-news'); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e('Color for the bullet points in the summary list.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
					</table>
				</div>
				...
				<div id="thunderbolt-page" class="tab-content" style="display:none;">
					<table class="form-table">
						<tr>
							<th scope="row">
								<label for="thunderbolt_logo_url"><?php esc_html_e('Logo Image URL', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<?php
								...
								<p class="description"><?php esc_html_e('URL of the logo image to display at the top left. Leave empty to hide logo.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="thunderbolt_theme"><?php esc_html_e('Theme', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<?php
								...
								<select name="hundred_words_news_settings[thunderbolt][theme]" id="thunderbolt_theme">
									<option value="dark" <?php selected($theme, 'dark'); ?>><?php esc_html_e('Dark', 'hundred-words-news'); ?></option>
									<option value="light" <?php selected($theme, 'light'); ?>><?php esc_html_e('Light', 'hundred-words-news'); ?></option>
									<option value="auto" <?php selected($theme, 'auto'); ?>><?php esc_html_e('Auto (System Preference)', 'hundred-words-news'); ?></option>
								</select>
								<p class="description"><?php esc_html_e('Theme for the Thunderbolt page.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="thunderbolt_bg_color"><?php esc_html_e('Background Color', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<?php
								$bg_color = $thunderbolt_settings['bg_color'] ?? '#000000';
								$preset_colors = array(
									'#000000' => __('Black', 'hundred-words-news'),
									'#1a1a1a' => __('Dark Gray', 'hundred-words-news'),
									'#0a0e27' => __('Navy Blue', 'hundred-words-news'),
									'#1a0d0d' => __('Dark Red', 'hundred-words-news'),
									'#0d1a0d' => __('Dark Green', 'hundred-words-news'),
								);
								?>
								...
								<p class="description"><?php esc_html_e('Background color for the Thunderbolt page.', 'hundred-words-news'); ?></p>
								<!-- <div style="margin-top: 10px;">
									<strong><?php esc_html_e('Preset Colors:', 'hundred-words-news'); ?></strong>
						...
						<tr>
							<th scope="row">
								<label for="thunderbolt_card_bg_color"><?php esc_html_e('Card Background Color', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<?php
								...
								<p class="description"><?php esc_html_e('Background color for individual post cards.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<?php esc_html_e('Show Share Sidebar', 'hundred-words-news'); ?>
							</th>
							<td>
								<?php
								...
								<label>
									...
									<?php esc_html_e('Show share buttons sidebar on post cards', 'hundred-words-news'); ?>
								</label>
							</td>
						</tr>
						<tr>
							<th scope="row" colspan="2">
								<h3 style="margin: 20px 0 10px 0;"><?php esc_html_e('Navigation Settings', 'hundred-words-news'); ?></h3>
							</th>
						</tr>
						<tr>
							<th scope="row">
								<label for="thunderbolt_nav_position"><?php esc_html_e('Navigation Arrows Position', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<?php
								$nav_position = $thunderbolt_settings['nav_position'] ?? 'right-center';
								$nav_positions = array(
									'right-center' => __('Right Side (Centered)', 'hundred-words-news'),
									'right-top' => __('Right Side (Top)', 'hundred-words-news'),
									'right-bottom' => __('Right Side (Bottom)', 'hundred-words-news'),
									'left-center' => __('Left Side (Centered)', 'hundred-words-news'),
									'left-top' => __('Left Side (Top)', 'hundred-words-news'),
									'left-bottom' => __('Left Side (Bottom)', 'hundred-words-news'),
								);
								?>
								...
								<p class="description"><?php esc_html_e('Position of navigation arrows on desktop and tablet.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="thunderbolt_nav_color"><?php esc_html_e('Navigation Arrows Color', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<?php
								...
								<p class="description"><?php esc_html_e('Color for navigation arrow icons. Leave empty to use theme default.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="thunderbolt_nav_bg_color"><?php esc_html_e('Navigation Arrows Background Color', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<?php
								...
								<p class="description"><?php esc_html_e('Background color for navigation arrows. Leave empty to use transparent background.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="thunderbolt_nav_font_size"><?php esc_html_e('Navigation Arrows Font Size', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<?php
								...
								<p class="description"><?php esc_html_e('Font size for navigation arrows (e.g., 20px, 1.5rem).', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row" colspan="2">
								<h3 style="margin: 20px 0 10px 0;"><?php esc_html_e('Typography Settings', 'hundred-words-news'); ?></h3>
							</th>
						</tr>
						<tr>
							<th scope="row">
								<label for="thunderbolt_title_font_size"><?php esc_html_e('Title Font Size', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<?php
								...
								<p class="description"><?php esc_html_e('Font size for post titles (e.g., 1rem, 18px, 1.2em).', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="thunderbolt_title_color"><?php esc_html_e('Title Color', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<?php
								...
								<p class="description"><?php esc_html_e('Color for post titles. Leave empty to use theme default.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="thunderbolt_meta_font_size"><?php esc_html_e('Metadata Font Size', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<?php
								...
								<p class="description"><?php esc_html_e('Font size for category and date metadata (e.g., 0.70rem, 12px).', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="thunderbolt_meta_color"><?php esc_html_e('Metadata Color', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<?php
								...
								<p class="description"><?php esc_html_e('Color for category and date metadata. Leave empty to use theme default.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="thunderbolt_content_font_size"><?php esc_html_e('Content Font Size', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<?php
								...
								<p class="description"><?php esc_html_e('Font size for summary content text (e.g., 0.75rem, 14px).', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="thunderbolt_content_color"><?php esc_html_e('Content Color', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<?php
								...
								<p class="description"><?php esc_html_e('Color for summary content text. Leave empty to use theme default.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="thunderbolt_bullet_color"><?php esc_html_e('Content Bullet Color', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<?php
								...
								<p class="description"><?php esc_html_e('Color for bullet points in the summary list.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row" colspan="2">
								<h3 style="margin: 20px 0 10px 0;"><?php esc_html_e('Read More Button Settings', 'hundred-words-news'); ?></h3>
							</th>
						</tr>
						<tr>
							<th scope="row">
								<label for="thunderbolt_readmore_bg_color"><?php esc_html_e('Read More Background Color', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<?php
								...
								<p class="description"><?php esc_html_e('Background color for the "Read more" button.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="thunderbolt_readmore_text_color"><?php esc_html_e('Read More Text Color', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<?php
								...
								<p class="description"><?php esc_html_e('Text color for the "Read more" button.', 'hundred-words-news'); ?></p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="thunderbolt_readmore_font_size"><?php esc_html_e('Read More Font Size', 'hundred-words-news'); ?></label>
							</th>
							<td>
								<?php
								...
								<p class="description"><?php esc_html_e('Font size for the "Read more" button text (e.g., 0.875rem, 14px).', 'hundred-words-news'); ?></p>
							</td>
						</tr>
					</table>
				</div>
